...
(() => {
  ...
  const STYLE_ID = "mana-v894-strength-fuel-style";
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .mana-v894-guide:first-of-type{
        border-top:0;
      }


      .mana-v894-guide strong{
        display:block;
        color:#eee;
        font-size:14px;
      }
  ...
  function ensureModal() {
    ...
    modal.innerHTML = `
      ...
      <div class="mana-v894-sheet">

        <div class="mana-v894-sheet-inner">

          <h2>
            Daily Fuel Targets
          </h2>

          <div class="mana-v894-field">
  ...
  function renderFuel() {
    ...
    holder.innerHTML = `
      ...
      <div
        class="mana-v894-progress"
      >

        <div
          class="mana-v894-head"
        >
        ...
        ${
          hasTargets
            ? `
              ...
              <div
                class="mana-v894-grid"
              >

                <div
                  class="mana-v894-stat"
                >

                  <div
                    class="mana-v894-label"
                  >
                    Calories
                  </div>

                  <div
                    class="mana-v894-value"
                  >
                    ${Math.round(
                      totals.calories
                    )}
                  ...
                  <div
                    class="mana-v894-track"
                  >
                    <div
                      class="mana-v894-fill"
                      style="
                        width:
                        ${pct(
                          totals.calories,
        ...
        <div
          class="mana-v894-water"
        >

          <div
            class="mana-v894-water-label"
          >
            Quick add water
          </div>

          <div
            class="mana-v894-water-grid"
          >

            <button
              type="button"
              class="mana-v894-water-btn"
              data-mana-water="250"
            >
              +250ml
            </button>
      ...
      >
        ...
        <div
          class="mana-v894-meal-grid"
        >

          <button
            type="button"
            class="mana-v894-meal"
            data-mana-meal="Breakfast"
          >
            <strong>Breakfast</strong>
            <span>Tap to add food</span>
          </button>
      ...
      >
        ...
        >
          ...
          <span>
            ...
            around training when practical.
          </span>
        ...
        >
          ...
          <span>
            ...
            instead of trying to catch up late.
          </span>
